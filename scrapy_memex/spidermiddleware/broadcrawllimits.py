...
from scrapy_memex.utils.url import is_external_url, get_domain
from scrapy_memex.utils.lists import split_list
...
class BroadCrawlLimitsMiddleware(object):
    ...
    def _filter_links_count(self, requests, response):
